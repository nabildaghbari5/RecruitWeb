...
import { HttpInterceptorService } from './account/guards/http-interceptor.service';
import { API_CONFIG, ApiConfig } from './shared/service/apiConfig';
...
const apiConfig: ApiConfig = {
  apiUrl: 'http://localhost:8081/'  // Ajoutez 'http://' pour le poblème de cross-origin il faux configurer juste dans le getway uniquement est n'est pas dans tous les micro-service
};
